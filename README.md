Made in C++ WITHOUT using .NET and other nonsense.
...
2. Download from release and run Clipper.exe or compile it yourself. (There is no GUI in the compiled version)
